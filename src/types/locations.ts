...
export const locations: LocationsData = {
  day1: {
    ...
    points: [
      ...
      {
        coords: [25.0485, 121.5172], type: "transit", title: "Taipei Main Station",
      ...
      {
        coords: [25.046369, 121.516886], type: "hotel", title: "Mayer Inn",
      ...
      {
        coords: [25.0425, 121.5065], type: "cafe", title: "Fong Da Coffee",
      ...
      {
        coords: [25.0435, 121.5075], type: "food", title: "บะหมี่อาจง",
      ...
      {
        coords: [25.0445, 121.5060], type: "food", title: "Tian Tian Li",
      ...
      {
        coords: [25.0438, 121.5068], type: "drink", title: "Xing Fu Tang",
      ...
      {
        coords: [25.0440, 121.5050], type: "food", title: "Hot-Star ไก่ทอด",
      ...
      {
        coords: [25.0428, 121.5062], type: "food", title: "Three Brothers Tofu Pudding",
      ...
      {
        coords: [25.0448, 121.5045], type: "shopping", title: "Don Don Donki",
      ...
      {
        coords: [25.0432, 121.5055], type: "photo", title: "ทางม้าลายสายรุ้ง",
      ...
      {
        coords: [25.046369, 121.516886], type: "hotel", title: "กลับที่พัก",
        desc: "พักผ่อน",
  ...
  day2: {
    ...
    points: [
      {
        coords: [25.046369, 121.516886], type: "hotel", title: "เริ่ม: Mayer Inn", desc: "08:00 ออกเดินทาง",
        review: "เตรียมขวดน้ำเปล่าไปด้วย วันนี้เดินเยอะ! (น้ำประปาที่ไต้หวันดื่มไม่ได้ แต่ตามสถานี MRT มีตู้กดน้ำฟรี)"
      },
      {
        coords: [25.0370, 121.4999], type: "temple", title: "วัดหลงซาน", desc: "ไหว้พระขอพรเช้า",
      ...
      {
        coords: [25.0366, 121.5025], type: "photo", title: "ย่าน Bopiliao", desc: "ชมตึกอิฐแดงโบราณ",
      ...
      {
        coords: [25.0355, 121.4988], type: "food", title: "Yuanfang Gua Bao", desc: "เบอร์เกอร์หมู Michelin",
        review: "แป้งนุ่มฟู หมูสามชั้นตุ๋นจนละลาย! ผักดองกับถั่วลิสงป่นช่วยตัดเลี่ยนได้ดีมาก สมราคามิชลิน แถวอาจจะยาวหน่อยแต่คุ้ม"
      },
      {
        coords: [25.0375, 121.5030], type: "food", title: "โจ๊กหมูกรอบ Zhouji", desc: "ข้าวต้มหมูกรอบมื้อสาย",
      ...
      {
        coords: [25.0487, 121.5115], type: "photo", title: "ประตูเมืองเหนือ (Beimen)", desc: "Beimen North Gate",
      ...
      {
        coords: [25.0630, 121.5338], type: "temple", title: "วัดสิงเทียน", desc: "เทพเจ้ากวนอู",
      ...
      {
        coords: [25.0438, 121.5315], type: "cafe", title: "Simple Kaffa", desc: "กาแฟแชมป์โลก",
      ...
      {
        coords: [25.0339, 121.5645], type: "shopping", title: "Taipei 101", desc: "เดินห้างหรู ย่านตึกสูง",
      ...
      {
        coords: [25.0355, 121.5660], type: "drink", title: "Chun Shui Tang", desc: "ชานมไข่มุกต้นตำรับ",
      ...
      {
        coords: [25.0558, 121.5155], type: "food", title: "ตลาดหนิงเซี่ย", desc: "Night Market",
      ...
      {
        coords: [25.046369, 121.516886], type: "hotel", title: "กลับที่พัก", desc: "จบทริปวันที่ 2",
  ...
  day3: {
    ...
    points: [
      {
        coords: [25.046369, 121.516886], type: "hotel", title: "เริ่ม: Mayer Inn", desc: "เช้า: เดินไปสถานีรถไฟ",
        review: "วันนี้ออกนอกเมือง พกร่ม/เสื้อกันฝนติดตัวไปด้วยเสมอ! เมือง Keelung และ Jiufen ฝนตกบ่อยมาก (Rainy City)"
      },
      {
        coords: [25.0478, 121.5171], type: "transit", title: "Taipei Main Station", desc: "ขึ้นรถไฟ TRA ไป Keelung",
      ...
      {
        coords: [25.1320, 121.7400], type: "city", title: "สถานี Keelung", desc: "ถึงเมืองท่าจีหลง",
        review: "เดินออกจากสถานีทางทิศใต้ (South Exit) จะเจอกับท่าเรือเลย กลิ่นทะเลเตะจมูก บรรยากาศชิลมาก"
      },
      {
        coords: [25.1285, 121.7425], type: "photo", title: "Maritime Plaza", desc: "วิวท่าเรือ",
        review: "จุดถ่ายรูปเช็คอินกับป้าย KEELUNG ตัวใหญ่ๆ และดูเรือสำราญลำยักษ์จอดเทียบท่า นกเหยี่ยวบินเยอะมาก ระวังขี้ตกใส่หัว!"
      },
      {
        coords: [25.1600, 121.7630], type: "sea", title: "เกาะเหอผิง", desc: "ชมหินรูปร่างแปลกตา",
      ...
      {
        coords: [25.1085, 121.8440], type: "photo", title: "A-Mei Tea House", desc: "โรงน้ำชาโคมแดง",
      ...
      {
        coords: [25.1098, 121.8455], type: "food", title: "บัวลอย A-Gan Yi", desc: "กินบัวลอยเผือกวิวทะเล",
      ...
      {
        coords: [25.0485, 121.5172], type: "transit", title: "กลับไทเป", desc: "รถบัส 965",
      ...
      {
        coords: [25.046369, 121.516886], type: "hotel", title: "ที่พัก", desc: "พักผ่อน",
  ...
  day4: {
    ...
    points: [
      {
        coords: [25.046369, 121.516886], type: "hotel", title: "Check-out", desc: "ฝากกระเป๋า",
        review: "Check-out และฝากกระเป๋าไว้ที่โรงแรมได้เลย (ฟรี) จะได้เดินตัวปลิวช้อปปิ้งของฝากรอบสุดท้าย"
      },
      {
        coords: [25.0460, 121.5135], type: "food", title: "ก๋วยเตี๋ยวเนื้อ Liu Shan Dong", desc: "มื้อเช้า (มิชลิน)",
      ...
      {
        coords: [25.046369, 121.516886], type: "hotel", title: "รับกระเป๋า", desc: "ที่โรงแรม",
